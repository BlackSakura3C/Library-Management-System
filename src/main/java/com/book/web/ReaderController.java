...
public class ReaderController {
    ...
    @Autowired
    public void setReaderInfoService(ReaderService readerService) {
    ...
    public ModelAndView allReaders(){
        ArrayList<Reader> readers=readerService.Readers();
        ModelAndView modelAndView=new ModelAndView("admin_readers");
        modelAndView.addObject("readers",readers);
        return modelAndView;
    }

    @RequestMapping("alllibrarys.html")
    public ModelAndView allLibrarys(){
        ArrayList<Library> libraries=readerService.libraries();
    ...
    public String readerDelete(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        boolean success=readerService.deleteReader(readerId);
    ...
    public String readerInfoAddDo(String name,String address,String phoneNumber,int readerId,RedirectAttributes redirectAttributes){
        Reader reader=new Reader();
        reader.setAddress(address);
        reader.setName(name);
        reader.setReaderId(readerId);
        reader.setPhoneNumber(phoneNumber);
        boolean succ=readerService.addReader(reader);
        ArrayList<Reader> readers=readerService.Readers();
        if (succ){
