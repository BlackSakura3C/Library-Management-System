    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    <td><c:out value="${666}"></c:out></td>
                    <td><c:out value="${alog.indexId}"></c:out></td>
                    <td><c:out value="${alog.readerId}"></c:out></td>
                    <td><c:out value="${alog.BDatetime}"></c:out></td>
                    <td><c:out value="${alog.RDatetime}"></c:out></td>
                    <td><a href="deletebook.html?IndexID=<c:out value="${666}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
